...
<div id="content">
 ...
 <div class="container-fluid">
    ...
    <div class="row">
                        ...
                        <div class="col mr-2">
                            ...
                            <?php
                                ...
                                if ($_SESSION['perfil'] == 2) {
                                    ...
                                    $status = 1;
                                    $tabela= "ordem";
                                    $total = consultaStatusClienteTercerizado($tabela,$cod_usuario,$status);
                                    echo ($total['0']['total']);
                                }
        ...
        <div class="col-xl-3 col-md-6 mb-4" id="cards-notice">
        <a href="../ordem/OrdemExecucao.php">
        ...
        <div class="col-xl-3 col-md-6 mb-4" id="cards-notice">
        <a href="../ordem/OrdemConcluidas.php">
